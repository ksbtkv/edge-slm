---
status: superseded by ADR-0005 (repo split) — the club/Visagio stakeholder reporting cadence this describes doesn't apply to the new product; `docs/project_status_report.md` and `docs/client_presentation.md` were removed from this repo's `main` accordingly.
---
